    ...
    <main className="min-h-screen flex flex-col">
      ...
      <section className="bg-gradient-to-r from-orange-600 to-orange-500 text-white py-12 md:py-20 px-4">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-3xl md:text-5xl font-bold mb-4">{aboutData.title}</h1>
          <p className="text-lg md:text-xl opacity-90">Learn about our journey and commitment to excellence</p>
          <Link
            href="/"
      ...
      <section className="flex-grow py-12 md:py-20 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <Card className="p-8 mb-8 shadow-lg">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">Who We Are</h2>
            <p className="text-gray-700 text-lg leading-relaxed">{aboutData.description}</p>
          </Card>
          ...
          {/* Values Section */}
          <div className="mt-12">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-8 text-center">Our Core Values</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Card className="p-6 text-center hover:shadow-lg transition">
                <div className="text-4xl mb-4">✅</div>
                <h4 className="font-bold text-lg text-gray-900 mb-2">Quality</h4>
                <p className="text-gray-600">Premium products that meet international standards</p>
              </Card>

              <Card className="p-6 text-center hover:shadow-lg transition">
                <div className="text-4xl mb-4">🌱</div>
                <h4 className="font-bold text-lg text-gray-900 mb-2">Sustainability</h4>
                <p className="text-gray-600">Environmentally responsible agricultural practices</p>
              </Card>

              <Card className="p-6 text-center hover:shadow-lg transition">
                <div className="text-4xl mb-4">🤝</div>
                <h4 className="font-bold text-lg text-gray-900 mb-2">Integrity</h4>
                <p className="text-gray-600">Honest and transparent dealings with all partners</p>
              </Card>
            </div>
          </div>
        </div>
