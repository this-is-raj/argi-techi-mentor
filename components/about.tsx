      ...
      <div className="max-w-7xl mx-auto px-3 md:px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
          ...
          <div className="bg-white rounded-xl md:rounded-2xl shadow-lg hover:shadow-xl transition-shadow p-6 md:p-8 border-l-4 border-primary">
            ...
            <p className="text-sm md:text-base text-muted-foreground leading-relaxed">{aboutData.mission}</p>
          </div>
          ...
          <div className="bg-white rounded-xl md:rounded-2xl shadow-lg hover:shadow-xl transition-shadow p-6 md:p-8 border-l-4 border-primary">
            ...
            <p className="text-sm md:text-base text-muted-foreground leading-relaxed">{aboutData.vision}</p>
          </div>
        </div>

        {/* Key Features */}
        <div className="mt-12 md:mt-16 pt-12 md:pt-16 border-t border-border">
          <h3 className="text-2xl md:text-3xl font-bold mb-8 md:mb-12 text-center text-foreground">Why Choose Us</h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
            {[
              { icon: "✓", title: "Quality Assured", desc: "100% certified products" },
              { icon: "🌏", title: "Global Reach", desc: "Export to 50+ countries" },
              { icon: "📦", title: "Fast Delivery", desc: "Reliable shipping services" },
              { icon: "🤝", title: "Customer First", desc: "Dedicated support team" },
            ].map((feature, idx) => (
              <div
                key={idx}
              ...
              >
                ...
                <h4 className="font-semibold text-foreground text-sm md:text-base mb-1 md:mb-2">{feature.title}</h4>
